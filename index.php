<?php require('header.php'); ?>
    <body id="page-top">
        ...
        <!-- Masthead-->
        <header class="masthead bg-bluedev text-white text-left">
		<div
  class="full-width-image d-none d-sm-none d-md-block p-5 text-center   text-white"
  style="background-image: url('public/images/bg-header-blog-large.jpg');"
>
...
<!-- </div> -->
            <div class="container d-flex align-items-center flex-column">
				...
				<span class="masthead-heading text-capitalize mb-3 ">Abderrahim Fathi</span>
        ...
        <section class="page-section bg-bluedev text-white mb-0" id="about">
            <div class="container">
                ...
                <div class="text-center mt-4">
                    <a class="btn btn-xl btn-outline-light" href="#cvmodal">
            ...
            <div class="modal-dialog modal-lg">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <embed src="documents/CV-Fathi Abderrahim2.pdf"
