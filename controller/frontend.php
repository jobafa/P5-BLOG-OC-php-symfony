...
//var_dump($token);
	...
	function userActivation($userid,$token,$isactivated)
	 {
		...
		//if ((isset($action)) && ($action ==  'useractivation')){
			...
			}elseif(isset($isactivated)){
				
				// WE ARE NOT COMING FROM USER'S ACTIVATION EMAIL
				$result = false;
