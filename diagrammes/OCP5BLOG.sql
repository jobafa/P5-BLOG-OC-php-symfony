...
--
-- Host: localhost:3306
-- Generation Time: Jun 17, 2022 at 04:49 PM
...
CREATE TABLE `user` (
  ...
  `is_enabled` char(1) NOT NULL,
  `is_activated` varchar(100) DEFAULT NULL,
  `pass_resetcode` varchar(100) DEFAULT NULL,
  `pass_resetdate` datetime DEFAULT NULL,
  `creation_date` datetime NOT NULL,
