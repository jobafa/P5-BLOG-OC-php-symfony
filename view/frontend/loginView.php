				...
				<div class="card-body">
					...
					<form action="index.php?action=verifylogin&amp;controller=user" method="post">
						...
						<div class="content-fluid alert-info  py-1 px-1 ">
							<p>
								<small>
									<a class="text-secondary mx-2 " href="passresetrequest-user.html#passresetrequest">J'ai oubli&eacute; mon Mot de Passe</a>Vous n'avez pas encore de compte <a class=" text-secondary mx-2" href="signinview-user.html#inscription">Inscrivez Vous</a>
								</small>
							</p>
						</div>
					</form>
